...
export default function ProductReviewTwo() {
    ...
    Reviews: [
      {
        ...
        rating: 5,
        comment: "Absolutely amazing product! The quality exceeded my expectations and the delivery was super fast. The packaging was professional and everything arrived in perfect condition.",
        likes: 24,
        dislikes: 2,
        comments: 8,
        date: "2024-01-15",
      ...
      },
      {
        ...
        rating: 4,
        comment: "Great value for money. The product works exactly as described and the customer service was helpful when I had questions.",
        likes: 18,
        dislikes: 1,
        comments: 5,
        date: "2024-01-12",
      ...
      },
      {
        ...
        rating: 5,
        comment: "This has completely changed my workflow! Highly recommended for anyone looking for a reliable solution. The build quality is exceptional.",
        likes: 31,
        dislikes: 0,
        comments: 12,
        date: "2024-01-10",
      ...
      },
      {
        ...
        rating: 3,
        comment: "Good product overall, but there's room for improvement in the user interface. Customer support was responsive though.",
        likes: 12,
        dislikes: 5,
        comments: 3,
        date: "2024-01-08",
      ...
      },
      {
        ...
        rating: 5,
        comment: "Perfect! Exactly what I was looking for. The attention to detail is impressive and it works flawlessly.",
        likes: 19,
        dislikes: 1,
        comments: 6,
        date: "2024-01-05",
      ...
      },
      {
        ...
        rating: 4,
        comment: "Very satisfied with this purchase. It arrived quickly and works as expected. Would definitely buy again.",
        likes: 15,
        dislikes: 2,
        comments: 4,
        date: "2024-01-03",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between flex-col lg:flex-row gap-12 mb-16">
          <div className="max-w-2xl">
            ...
            <p className="text-black max-w-sm poppins-medium leading-tight text-lg mb-8"
               style={{ fontFamily: 'Poppins, sans-serif' }}>
              Discover what our <span className="font-semibold text-green-500">customers</span> are saying 
          ...
          <div className="flex items-start justify-between max-w-md w-full gap-8">
            <div className="relative">
              ...
              <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                <StarRating rating={Math.floor(mockData.Average)} size="w-3 h-3" />
              </div>
            </div>
        ...
        {visibleReviews < filteredReviews.length && (
          <div className="text-center">
            ...
            >
              Show More Reviews ({filteredReviews.length - visibleReviews} remaining)
            </button>
          </div>
        )}
      </div>
